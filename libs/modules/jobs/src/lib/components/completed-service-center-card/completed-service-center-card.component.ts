...
@Component({
  selector: 'neural-completed-service-center-card',
  templateUrl: './completed-service-center-card.component.html',
  styleUrls: ['./completed-service-center-card.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CompletedServiceCenterCardComponent {
  ...
  handleDropWait(value: string) {
    switch (value) {
      case IReservations.Logistic.DROP_IN:
        return 'Drop';

      case IReservations.Logistic.WAIT:
        return 'Wait';
    }
  }
