...
@Component({
  selector: 'neural-service-center-statistics',
  templateUrl: './service-center-statistics.component.html',
  styleUrls: ['./service-center-statistics.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ServiceCenterStatisticsComponent {
