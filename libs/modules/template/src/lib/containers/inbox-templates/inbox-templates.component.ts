...
// facade
import { InboxTemplatesFacade } from '../../+state/facades';
...
export class InboxTemplatesComponent implements OnInit {
  ...
  onRefresh(event: boolean) {
    if (event) {
      ...
      this.templatesFacade.changeInboxTemplatesPage(config, filters);
    }
  }
  ...
  changePage(event: PageEvent) {
    ...
    this.templatesFacade.changeInboxTemplatesPage(params, filters);
  }
}
