...
@Component({
  selector: 'neural-purchase-quote-form',
  templateUrl: './purchase-quote-form.component.html',
  styleUrls: [
    './purchase-quote-form.component.scss',
    '../purchase-form/purchase-form.component.scss',
  ],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PurchaseQuoteFormComponent implements OnInit, OnChanges {
  ...
  bankLoanApplicationOffersUploadedFile$: Observable<ITradeIn.IDocument>;

  bankLoanApplicationOffersDeletedFile$: Observable<ISales.IDeleteFileResponse>;
  ...
  ngOnInit(): void {
    this.unit$ = this.purchaseQuotesFacade.unit$;
    this.globalVehicles$ = this.purchaseQuotesFacade.globalVehicles$;
  ...
  onBrandSeries(event: { brand: string; series: string }): void {
    this.purchaseQuotesFacade.onListSeriesModels(event);
  }

  onModelBrandSeries(event: IModels.IVariant): void {
    this.purchaseQuotesFacade.onListVariants(event);
  }
  ...
  onClearBadge(event: IPurchases.IUpdateBadge) {
    this.purchaseQuotesFacade.onClearBadge(event);
  }
  ...
  onGlobalBrandChange(event?: any): void {
    this.purchaseQuotesFacade.onLoadGlobalBrands();
  }

  onGlobalModelChange(payload: { brand: string }): void {
    this.purchaseQuotesFacade.onLoadGlobalModels(payload);
  }

  onGlobalVariantChange(payload: { brand: string; model: string }): void {
    this.purchaseQuotesFacade.onLoadGlobalVariants(payload);
  }

  onFileChange(payload: ISales.IUploadFile): void {
    this.tradeInUploadedFile$ = this.purchaseQuotesFacade
  ...
  onDeleteFile(payload: ISales.IDeleteFile): void {
    this.tradeInDeletedFile$ = this.purchaseQuotesFacade
  ...
  onFileBankLoanChange(payload: ISales.IUploadFile): void {
    this.bankLoanUploadedFile$ = this.purchaseQuotesFacade
      .onUploadDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onDeleteBankLoanFile(payload: ISales.IDeleteFile): void {
    this.bankLoanDeletedFile$ = this.purchaseQuotesFacade
      .onDeleteDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onFileInspectionChange(payload: ISales.IUploadFile): void {
    this.tradeInInspectionUploadedFile$ = this.purchaseQuotesFacade
      .onUploadDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onDeleteInspectionFile(payload: ISales.IDeleteFile): void {
    this.tradeInInspectionDeletedFile$ = this.purchaseQuotesFacade
      .onDeleteDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onFileOfferChange(payload: ISales.IUploadFile): void {
    this.tradeInOfferUploadedFile$ = this.purchaseQuotesFacade
      .onUploadDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onDeleteOfferFile(payload: ISales.IDeleteFile): void {
    this.tradeInOfferDeletedFile$ = this.purchaseQuotesFacade
      .onDeleteDocument(payload)
      .pipe(
        catchError((res: any) => {
          this.toggleSnackbar(res.error.response.message);
  ...
  onUploadBankLoanApplicationOffersFile(data: ISales.IUploadFile): void {
    this.bankLoanApplicationOffersUploadedFile$ = this.purchaseQuotesFacade
  ...
  onDeleteBankLoanApplicationOffersFile(data: ISales.IDeleteFile): void {
    this.bankLoanApplicationOffersDeletedFile$ = this.purchaseQuotesFacade
