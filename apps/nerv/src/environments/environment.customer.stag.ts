...
export const environment: Environment = {
  ...
  sandbox: false,
  development: false,
  version: `${version}-customer-staging`,
  identifier: 'io.whipmobility.nerv-customer',
  api: {
    community: 'https://skyrim-customer.whipmobility.io',
    application: 'https://nerv-customer.whipmobility.io',
  },
  google: {
    maps: {
